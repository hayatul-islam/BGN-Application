...
function MeetTheTeam() {
  return (
    <>
      <div className="grid md:grid-cols-2 gap-12 pt-[80px] lg:pt-[250px] pb-12 px-[20px] sm:px-[30px]">
        <div>
          <div className="relative z-0">
            <img
              className="w-[90%] h-full rounded-[20px] lg:rounded-[40px] md:rounded-r-[40px] grayscale"
            ...
            />
            <img
              className="hidden sm:block w-[126px] h-[100px] lg:w-[200px] lg:h-[160px] xl:w-[250px] xl:h-[200px] absolute top-0 rounded-[20px] lg:rounded-[40px] grayscale"
            ...
            />
            <img
              className="hidden sm:block w-[126px] h-[100px] lg:w-[250px] lg:h-[200px] absolute bottom-0 right-0 rounded-[20px] lg:rounded-[40px] grayscale"
        ...
        <div className="space-y-6">
          ...
          <div>
            <button className="uppercase border border-[#ffb937] text-[24px] lg:text-[26px] py-2 xl:py-4 px-5 lg:px-12 w-full md:w-auto rounded-lg">
              Meet The Team
            </button>
          </div>
        </div>
