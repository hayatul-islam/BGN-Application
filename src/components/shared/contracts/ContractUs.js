        ...
        <div className="p-12">
          ...
          <form>
            <div className="mb-6">
              <label
                for="email"
                className="block mb-1 text-[12px] md:text-[16px] font-bold "
              >
                First Name
              </label>
              <input
            ...
            <div className="mb-6">
              <label className="block mb-1 text-[12px] md:text-[16px] font-bold ">
                Email Address
              </label>
            ...
            <button
              type="submit"
              className="w-full border py-2 md:py-5 border-[#ffb937] text-[18px] md:text-[24px] hover:text-[#000] uppercase hover:bg-[#ffb937] rounded "
            >
              Submit
            </button>
          </form>
        </div>
        <div className=" hidden lg:block xl:max-h-[950px]">
          <img
